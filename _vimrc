...
if g:iswindows
set luadll=$VIM/tools/lua/lua5.1.dll
let $PYTHONHOME=$VIM . "/tools/python27"
let $PYTHONPATH=$VIM . "/tools/python27/Lib"
set pythondll=$VIM/tools/python27/python27.dll
endif
...
"H" cnoremap <C-e> <End>
"H" cnoremap <C-h> <Left>
"H" cnoremap <C-l> <Right>
"H" cnoremap <C-b> <S-Left>
"H" cnoremap <C-f> <S-Right>
